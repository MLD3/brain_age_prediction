...
inputFile = 'numpyArrays/'
outputFile = 'avg_max_mix/'

df = pd.read_csv('../PNC_724_phenotypics.csv')
...
for _, row in df.iterrows():
    ...
    np.save('{}{}{}.npy'.format(outputFile, subject), mix_image1)
    np.save('{}{}{}.npy'.format(outputFile, subject), mix_image2)
    np.save('{}{}{}.npy'.format(outputFile, subject), mix_image3)
    np.save('{}{}{}.npy'.format(outputFile, subject), mix_image4)
